			...
			<div class="field f_100">
				<div class="option clearfix">
					...
					<div id="wp_automatic_gallery_create" class="field f_100 ">
						...
						<div class="description">*By default, the gallery will be added to the top of the post content and if you want to change the location, add the tag [the_gallery] anywhere in the "Post text template" above.</div>
